...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <a href="add_user.php"><button class="btn-default">Добавить нового пользователя</button> </a>
        <?php foreach ($all as $users): ?>
            ...
            <tr>
                ...
                <form action="edit_news.php" method="get"><input type="hidden" name="id" value="<?php echo $users['id']?>"/>
                    <td width="5%"><a href="edit_news.php"> <input class="btn-success" type="submit" name="action" value="редактировать"></a></form> </td>
                <form action="" method="post"><input type="hidden" name="id" value="<?php echo $users['id']?>"/>
